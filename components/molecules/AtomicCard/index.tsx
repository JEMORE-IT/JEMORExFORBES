...
export function AtomicCard({
  ...
  return (
    ...
    >
      <Card
        className={cn(
          'h-full overflow-hidden border-zinc-800/40 bg-[#0a0a0a]/60 text-white shadow-2xl backdrop-blur-md',
          className
        )}
      >
        {immagine && (
        ...
        <CardContent className="px-6 pb-6 text-sm italic text-zinc-400">
          {description}
        </CardContent>
      </Card>
    </motion.div>
